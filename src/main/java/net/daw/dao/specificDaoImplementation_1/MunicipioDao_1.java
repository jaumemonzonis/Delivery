 ...
 */
public class MunicipioDao_1 extends GenericDaoImplementation implements DaoInterface{
     public MunicipioDao_1(Connection oConnection, String ob,UsuarioBean oUsuarioBeanSession) {
    ...
    public int getcountX(int idajena) throws Exception {//hacer private, consultar desde el pojo y no poder preguntar desde fuera del servidor
        ...
        strSQL_getcount = "SELECT COUNT(id) FROM " + ob + " WHERE id_area=" + idajena;
    ...
    @Override
     public ArrayList<BeanInterface> getpageX(int iRpp, int iPage, int idajena, HashMap<String, String> hmOrder, Integer expand) throws Exception {
        strSQL_WhereGetpagex = " WHERE id_area=?";
