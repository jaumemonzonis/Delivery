 ...
 */
public class Restaurante_municipioDao_2 extends GenericDaoImplementation implements DaoInterface{
     public Restaurante_municipioDao_2(Connection oConnection, String ob,UsuarioBean oUsuarioBeanSession) {
