 ...
 */
public class AreaDao_2 extends GenericDaoImplementation implements DaoInterface{
     public AreaDao_2(Connection oConnection, String ob,UsuarioBean oUsuarioBeanSession) {
 ...
 @Override
    public int getcountX(int idajena) throws Exception {//hacer private, consultar desde el pojo y no poder preguntar desde fuera del servidor
        ...
        strSQL_getcount = "SELECT COUNT(id) FROM " + ob + " WHERE id_municipio=" + idajena;
    ...
    public ArrayList<BeanInterface> getpageX(int iRpp, int iPage, int idajena, HashMap<String, String> hmOrder, Integer expand) throws Exception {
        strSQL_WhereGetpagex = " WHERE id_municipio=?";
