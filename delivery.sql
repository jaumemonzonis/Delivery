...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2019 a las 08:45:33
...
CREATE TABLE `factura` (
  ...
  `direccion_pedido` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `poblacion_pedido` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
(2, '2019-02-13 00:00:00', 21, 'local', 'local', 1, 3),
(3, '2019-02-14 00:00:00', 21, 'local', 'local', 1, 3),
(4, '2019-02-14 00:00:00', 21, 'local', 'local', 1, 3),
(5, '2019-02-14 00:00:00', 21, 'local', 'local', 1, 3),
(6, '2019-02-14 00:00:00', 21, 'local', 'local', 1, 3),
(7, '2019-02-14 00:00:00', 21, 'local', 'local', 1, 6),
(8, '2019-02-15 00:00:00', 21, 'local', 'local', 1, 4),
(9, '2019-02-15 00:00:00', 21, 'local', 'local', 1, 4),
(10, '2019-02-16 00:00:00', 21, 'local', 'local', 1, 4),
(11, '2019-02-16 00:00:00', 21, 'local', 'local', 1, 3),
(12, '2019-02-16 00:00:00', 21, 'local', 'local', 1, 4);
...
(14, 'A001', 'Ensalada Cesar', 'Variedad de brotes, tomates, pimientos rojos, salsa cesar y palomitas de maiz', 100, 4, 'cesare.jpg', 3),
(15, 'A002', 'Ensalada clásica', 'Variedad de brotes, tomates, cebolla, nueces y zanahoria.\r\n', 99, 4, 'mediterranea.jpg', 3),
(16, 'A003', 'Cous cous\r\n', 'Cous cous con aguacate, alubias rojas, maí­z, cacahuetes con aliño de lima y tabasco.\r\n', 100, 4, 'couscous.jpg', 3),
...
(1, 'Eat It Valencia', 'Calle Juan de Juanes 23', 'Valencia'),
...
(7, 'Eat It Albalat', 'Calle Maria Moliner 23', 'Albalat dels Tarongers'),
...
DROP TABLE IF EXISTS `restaurante_municipio`;
...
--
-- Truncar tablas antes de insertar `restaurante_municipio`
--

TRUNCATE TABLE `restaurante_municipio`;
--
...
(1, 'Jaume', 'Monzonis', 'Lazaro', 666666666, 'jaume', '5C633EE1B9C2C7814422BDFC98106CD96FA651899D54B99DAAF5897AC720CEC4', 'jaume_monzonis@hotmail.com', 'Calle Juan Perales 23', 'Museros', 'x5C3wJ7gT7Xbj5vYaL7nnmD3nq0tVS6IINbuBBGjiIMK2YdbdCarn3yZsUO6swDLCrC656Oi1BNzYHPchd5ZpR73DxceMCR84LpPwlDkhFfF5Am5QYYOoNgQpmDeRE16UTsyh9Kzni6ejprgdmFGOOovowx6wQf7OxDuH213y0fb6CEtD7xztF10RsL776fLXx57Lu2lfKBsbEiiDx96ohmf7RRFq8mUhQvVbyJbGhNDHdoLq14F3r9q3nQhW4G', 1, 2),
(2, 'Pepe', 'Rodirs', 'Juanes', 666000333, 'pepe', '7C9E7C1494B2684AB7C19D6AFF737E460FA9E98D5A234DA1310C97DDF5691834', 'jaume@hotmail.com', 'Calle Jorge Juan 34', 'Museros', 'x5C3wJ7gT7Xbj5vYaL7nnmD3nq0tVS6IINbuBBGjiIMK2YdbdCarn3yZsUO6swDLCrC656Oi1BNzYHPchd5ZpR73DxceMCR84LpPwlDkhFfF5Am5QYYOoNgQpmDeRE16UTsyh9Kzni6ejprgdmFGOOovowx6wQf7OxDuH213y0fb6CEtD7xztF10RsL776fLXx57Lu2lfKBsbEiiDx96ohmf3RRFq7mUhQvVbyJbGhNDHdoLq9F3r9q3nQhW8G', 1, 1),
(4, 'Iris', 'Juanes', 'Montoliu', 666333666, 'iris', '47612b3175fece07f6c3e91992412c5b16ca88a9068cb72fecbcf653eb5ffcd7', 'jaume_monzonis@hotmail.com', 'Calle Viles 23', 'Valencia', 'FcxO70GQCCokABsLNZIkx8761cqeo4rbOsoEDWVFUheKgdUmDck7xnkepPy9mm0l65zLSX1lHcXOkbuHfMHczjkiCkobfp6ATNSuzX1t1gpmKCNUE5IfIX62m0pf2OBnpy8uyEOvudpLQKI4nfXeax1jTTydihYdbw3IxUbLwx6ddhszQ9Dnm3mFLXk1DdJddtv39T6qXyoF8jLqtwYM6ZxCMFOvnvau0JkmKCUkUokaNjz4NM7EbEJ8AwpDBdZ', 1, 2),
(5, 'Juan', 'Lopez', 'Lopez', 666333444, 'juan', 'ed08c290d7e22f7bb324b15cbadce35b0b348564fd2d5f95752388d86d71bcca', 'jaume_monzonis@hotmail.com', 'Calle Juanes 1', 'valencia', 'x5C3wJ7gT7Xbj5vYaL7nnmD3nq0tVS6IINbuBBGjiIMK2YdbdCarn3yZsUO6swDLCrC656Oi1BNzYHPchd5ZpR73DxceMCR84LpPwlDkhFfF5Am5QYYOoNgQpmDeRE16UTsyh9Kzni6ejprgdmFGOOovowx6wQf7OxDuH213y0fb6CEtD7xztF10RsL776fLXx57Lu2lfKBsbEiiDx96ohmf3RRFq8mUhQvVbyJbGhNDHdoLq14F3r9q3nQhW8G', 1, 2),
(6, 'Lara', 'Rodriguez', 'Cortes', 666666666, 'juan', 'ed08c290d7e22f7bb324b15cbadce35b0b348564fd2d5f95752388d86d71bcca', 'jaume_monzonis@hotmail.com', 'Plaza Ayuntamiento 23', 'Moncada', '', 0, 0);
